...
function checkForecastMain(forecastMain) {
  if (forecastMain === "Rain") {
    $(`.new-${count}`).append('<img src="../assets/images/rain.png" alt="rain" height="50px"><br> ______________________<br><br>');
  }
  else if (forecastMain === "Drizzle") {
    $(`.new-${count}`).append('<img src="../assets/images/drizzle.png" alt="drizzle" height="50px"><br>______________________<br><br>');
  }
  else if (forecastMain === "Clear") {
    $(`.new-${count}`).append('<img src="../assets/images/sunny.png" alt="sunny" height="50px"><br>______________________<br><br>');
  }
  else if (forecastMain === "Snow") {
    $(`.new-${count}`).append('<img src="../assets/images/snow.png" alt="snow" height="50px"><br>______________________<br><br>');
  }
  else if (forecastMain === "Thunderstorm") {
    $(`.new-${count}`).append('<img src="../assets/images/lightning.png" alt="thunderstorm." height="50px"><br>______________________<br><br>');
  }
  else if (forecastMain === "Clouds") {
    $(`.new-${count}`).append('<img src="../assets/images/cloudy.png" alt="clouds" height="50px"><br>______________________<br><br>');
  }
}
